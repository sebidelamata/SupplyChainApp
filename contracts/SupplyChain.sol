...
contract supplyChain {
    ...
    // a structure is a collection different variables (kinda like an array/list)
    // we use this structure to define something (kind of like a class) with attributes
    // this defines what a product is
    struct product {
    ...
    // mapping creates a list, and maps one item to another,
    // in this we map a uint32 value to a product structure
    // here we use the product id, and call it product
    // the mapping of the product ids in a list called products
    mapping(uint32 => product) public products;

 
    // this structure stores our participant information
    ...
    // we map our participant id to our list of participants
    mapping(uint32 => participant) public participants;

 

    // this structure relates a product and an owner
   struct ownership {
